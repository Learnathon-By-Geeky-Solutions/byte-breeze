...
public class SSLCommerzPaymentApiController {
    ...
    public SSLCommerzPaymentApiController(SSLCommerzPaymentService sslCommerzPaymentService, PaymentRepository paymentRepository, ParcelRepository parcelRepository) {
    ...
    @PostMapping("/failure")
    public String handlePaymentFailure(@RequestParam Map<String, String> paramMap, RedirectAttributes redirectAttributes) {
        // Extract transaction details
        String transactionId = paramMap.get("tran_id");
    ...
    @PostMapping("/cancel")
    public String handlePaymentCancel(@RequestParam Map<String, String> paramMap, RedirectAttributes redirectAttributes) {
        // Extract transaction details
        String transactionId = paramMap.get("tran_id");
